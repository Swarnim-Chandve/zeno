...
.border-avalanche-200 {
  --tw-border-opacity: 1;
  border-color: rgb(186 230 253 / var(--tw-border-opacity, 1));
}
.border-avalanche-500 {
  --tw-border-opacity: 1;
...
/* Override specific text colors that might be set by components */
.text-gray-600,
.text-gray-500,
.text-gray-700,
.text-avalanche-600,
...
.hover\:text-avalanche-700:hover {
  --tw-text-opacity: 1;
  color: rgb(3 105 161 / var(--tw-text-opacity, 1));
}
...
.focus\:border-avalanche-500:focus {
  --tw-border-opacity: 1;
  border-color: rgb(14 165 233 / var(--tw-border-opacity, 1));
}
...
.focus\:ring-avalanche-500:focus {
  --tw-ring-opacity: 1;
...
.disabled\:from-yellow-500\/50:disabled {
  --tw-gradient-from: rgb(234 179 8 / 0.5) var(--tw-gradient-from-position);
  --tw-gradient-to: rgb(234 179 8 / 0) var(--tw-gradient-to-position);
  --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);
}

.disabled\:to-yellow-600\/50:disabled {
